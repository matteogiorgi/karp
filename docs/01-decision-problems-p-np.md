...
<p align="center">§1 — [§2](02-purpose-of-complexity-classes.md) — [§3](03-polynomial-many-one-reductions.md) — [§4](04-purpose-of-reductions.md) — [§5](05-cook-levin-and-practice.md) — [§6](06-pipeline-architecture.md)</p>
